...
public class SymmetricMap<K, V> extends AbstractMap<K, V> {
    ...
    /**
     * Creates a new {@code SymmetricMap} with the default initial capacity (16)
    ...
    /**
     * Creates a new {@code SymmetricMap} with the given initial capacity and
     ...
     */
    public SymmetricMap(int initialCapacity) {
     ...
     */
    public SymmetricMap(int initialCapacity, float loadFactor) {
    ...
    /**
     * Returns the key associated with the given value, or {@code null} if not found.
     *
     * @param value the value to look up
     * @return the key associated with {@code value}, or {@code null}
     */
     ...
     * @return the key that was associated with {@code value}, or {@code null} if
     *         not found
     */
     ...
     */
    public SymmetricMap<V, K> inverse() {
        SymmetricMap<V, K> inv = new SymmetricMap<>(table.length, loadFactor);
        for (Bucket b : table) {
    ...
    private Bucket[] newTable(int capacity) {
        Bucket[] t = (Bucket[]) new Object[capacity];
    ...
    private class KeySetView extends AbstractSet<K> {
        ...
        @Override
        public int size() { return SymmetricMap.this.size(); }
        ...
        public boolean remove(Object o) {
            return SymmetricMap.this.remove(o) != null;
        }

        @Override
        public void clear() { SymmetricMap.this.clear(); }
    ...
    private class EntrySetView extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean remove(Object o) {
            if (!(o instanceof Map.Entry)) return false;
            Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
            return SymmetricMap.this.remove(e.getKey()) != null;
        }
